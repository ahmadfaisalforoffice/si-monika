...
import { FileText, CheckCircle, Clock, AlertCircle, Activity as ActivityIcon, BarChart2, XCircle, Hourglass } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between bg-transparent pb-2">
        <div>
          <h2 className="text-2xl font-bold text-slate-800">Dashboard PIC Administrasi</h2>
          <p className="text-slate-500 mt-1">Ringkasan status kelengkapan dokumen seluruh kegiatan.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
          <div className="px-6 py-5 border-b border-slate-100 bg-slate-50/50">
            <h3 className="text-lg font-semibold text-slate-800">History Kegiatan Terbaru</h3>
          </div>
